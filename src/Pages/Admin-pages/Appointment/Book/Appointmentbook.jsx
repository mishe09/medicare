...
//                   <option value="dr-rose">Dr. Emily Rose</option>
//                   <option value="dr-joseph">Dr. Hadassah Joseph</option>
//                   <option value="dr-kumar">Dr. Rakesh Kumar</option>
//                   <option value="dr-lee">Dr. Sarah Lee</option>
//                 </select>
//               </div>
//             </div>
...
export default function PatientDetail() {
  const [darkMode, setDarkMode] = useState(false); // 🌓 Added local dark mode state
