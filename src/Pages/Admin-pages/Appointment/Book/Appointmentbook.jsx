...
//       {/* 🔹 Form Container */}
//       <div
//         className={`p-4 md:p-6 rounded-lg shadow-md border transition-colors duration-300 ${
//           darkMode
...
//           {/* form continues same as your version */}
//         </div>
...
export default function Appointmentbooking({ darkMode, setDarkMode }) {
  return (
    <div
    ...
    >
      ...
      >
        <h2
          className={`text-md font-semibold mb-4 ${darkMode ? "text-gray-100" : "text-gray-700"
            }`}
        >
          Basic Information
        </h2>
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-sm">First Name</label>
            <div
              className={`flex items-center border rounded-lg px-3 py-2 ${darkMode ? "border-gray-700 bg-gray-900" : "border-gray-300"
                }`}
            >
              <User
                size={16}
                className={`${darkMode ? "text-gray-400" : "text-gray-400"} mr-2`}
              />
              <input
                type="text"
                placeholder="First Name"
                className={`w-full outline-none text-sm bg-transparent ${darkMode ? "text-gray-100 placeholder-gray-500" : ""
                  }`}
              />
            </div>
          </div>
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <input
                  type="date"
                  className={`w-full outline-none text-sm bg-transparent ${darkMode ? "text-gray-100" : ""
                    }`}
                />
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <select
                  className={`w-full outline-none text-sm bg-transparent ${darkMode ? "text-gray-100" : "text-gray-700"
                    }`}
                >
        ...
        <div className="flex justify-end mt-6 gap-3">
          <button
            type="submit"
            className="bg-[rgb(213,151,71)] text-white px-5 py-2 rounded-md hover:bg-[rgb(190,130,60)] transition"
          >
            Submit
          </button>
          <button
