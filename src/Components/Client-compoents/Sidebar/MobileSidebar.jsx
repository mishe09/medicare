...
export default function MobileSidebar({ expanded, setExpanded, darkMode }) {
  ...
  return (
    <aside className="fixed top-14 left-0 h-full w-60 m-4 shadow-sm rounded-xl z-50 transition-transform bg-white dark:bg-gray-800">
      <nav className="h-full flex flex-col">
        ...
        <ul className="flex-1 px-2 space-y-2">
          ...
          <li>
            ...
            >
              ...
              {openMenus.Medication ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
            </div>
        ...
        {/* Profile Section */}
        <div className={`border-t p-3 relative ${darkMode ? "border-gray-700" : ""}`}>
